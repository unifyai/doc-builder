...
def move_folders_to_classes():
    ...
    write_header_and_toctree_to_rst(os.path.join(doc_path, 'stateful'),
                                    os.path.join(doc_path, 'stateful.rst'),
                                    'Framework Classes',
                                    'ivy.stateful',
                                    'stateful')

    write_header_and_toctree_to_rst(os.path.join(doc_path, 'data_classes', 'array'),
                                    os.path.join(
                                        doc_path, 'data_classes', 'array.rst'),
                                    'Array',
                                    'ivy.Array',
                                    'array')

    write_header_and_toctree_to_rst(os.path.join(doc_path, 'data_classes', 'container'),
                                    os.path.join(
                                        doc_path, 'data_classes', 'container.rst'),
                                    'Container',
                                    'ivy.Container',
                                    'container')

    write_header_and_toctree_to_rst(os.path.join(doc_path, 'data_classes'),
                                    os.path.join(
                                        doc_path, 'data_classes.rst'),
                                    'Data Classes',
                                    'ivy.data_classes',
                                    'data_classes')
    ...
    files = [file for file in os.listdir(
        os.path.join(doc_path, 'data_classes')) if '.rst' in file]
    toctree_dict['data_classes'] = files
    append_toctree_to_rst(toctree_dict, os.path.join(
        doc_path, 'index.rst'), 'Data Classes', False)

    toctree_dict = {}
    files = [file for file in os.listdir(
        os.path.join(doc_path, 'stateful')) if '.rst' in file]
    toctree_dict['stateful'] = files
    append_toctree_to_rst(toctree_dict, os.path.join(
        doc_path, 'index.rst'), 'Framework Classes', False)
