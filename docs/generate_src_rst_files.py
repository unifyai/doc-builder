...
def create_index_rst(sub_contents_dict):
    ...
    toctree_dict['docs'] = ['ivy.rst', 'ivy_mech.rst', 'ivy_vision.rst', 'ivy_robot.rst', 'ivy_memory.rst', 'ivy_gym.rst']
    os.makedirs('autogenerated_source/docs', exist_ok=True)
    with open('autogenerated_source/docs/ivy.rst', 'w+') as file:
        file.write('Ivy\n' + '='*3)
    with open('autogenerated_source/docs/ivy_mech.rst', 'w+') as file:
        file.write('Ivy Mech\n' + '='*8)
    with open('autogenerated_source/docs/ivy_vision.rst', 'w+') as file:
        file.write('Ivy Vision\n' + '='*10)
    with open('autogenerated_source/docs/ivy_robot.rst', 'w+') as file:
        file.write('Ivy Robot\n' + '='*9)
    with open('autogenerated_source/docs/ivy_memory.rst', 'w+') as file:
        file.write('Ivy Memory\n' + '='*10)
    with open('autogenerated_source/docs/ivy_gym.rst', 'w+') as file:
        file.write('Ivy Gym\n' + '='*7)
...
def main(root_dir, submodules_title):
    ...
    files = create_rst_files(root_dir)
